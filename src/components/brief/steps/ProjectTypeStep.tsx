...
const projectTypeIcons: Record<string, React.ReactNode> = {
  ...
  "maintenance": (
    <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.1-5.1a7.065 7.065 0 010-10l.354-.354a.75.75 0 011.06 0l4.95 4.95a.75.75 0 010 1.06l-.354.354m0 0l5.1 5.1a7.065 7.065 0 010 10l-.354.354a.75.75 0 01-1.06 0l-4.95-4.95a.75.75 0 010-1.06l.354-.354m0 0l-1.06-1.06" />
    </svg>
  ),
};
