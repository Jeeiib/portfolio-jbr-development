...
Une chose à comprendre d'abord, parce qu'elle change l'ordre des priorités : les coordonnées, les horaires et les avis que Google affiche dans ses résultats viennent de votre fiche, pas de votre site. On me demande régulièrement d'ajouter un balisage technique sur un site pour faire apparaître des horaires ou des étoiles. Ça ne fonctionne pas comme ça. Le balisage aide Google à comprendre vos pages, mais ce qui s'affiche dans l'encadré local, c'est la fiche. Un site parfait avec une fiche vide, c'est une vitrine sans enseigne.
